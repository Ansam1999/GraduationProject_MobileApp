...
function KindergartenAccount(props) {
    ...
    return (
        ...
        <View style={styles.Container} >
            ...
            <Text style={{color:'white',fontSize:18,marginRight:270,marginTop:-5,marginTop:7}}>  Username  </Text>
              <TextInput placeholder="  Name of the kindergarten" style={[styles.Input,styles.font]} />
              ...
              <Text style={{color:'white',fontSize:18,marginRight:230,marginTop:-5,marginTop:7}}>  Phone Number  </Text>
              <TextInput placeholder="  Phone Number" style={[styles.Input,styles.font]} />
              <Text style={{color:'white',fontSize:18,marginRight:270,marginTop:-5,marginTop:7}}>  Address  </Text>
              <TextInput placeholder="  Address of the kindergarten" style={[styles.Input,styles.font]} />
...
export default KindergartenAccount;